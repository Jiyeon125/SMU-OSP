...
export default function ProjectMemberManagementDialog({
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: async (response, { memberId, approve }) => {
            ...
            setMessage(approve ? "참가 신청을 승인했습니다." : "참가 신청을 반려했습니다.");
                ...
                <DialogBody pb={6}>
                    ...
                    {membersQuery.isLoading ? (
                        ...
                        <StatusMessagePanel
                            ...
                            description={response?.detail.message || "잠시 후 다시 시도해주세요."}
                        />
                                ...
                                >
                                    <Box>
                                        ...
                                        <Text fontSize="sm" color="smu.darkGray">
                                            {PROJECT_APPLICATION_STATUS_LABEL[member.status]} ·
                                            신청일 {formatDateTimeKST(member.createdAt)}
                                        </Text>
                                        {member.description && (
